...
router.post('/',rolVerification.admin,validatorHandler(createCategorySchema, 'body'),categoryController.createCategory);
router.delete('/:id',rolVerification.admin,validatorHandler(idByParamsSchema, 'params'),categoryController.deleteCategory);
router.put('/:id',rolVerification.admin,validatorHandler(createCategorySchema, 'body'),validatorHandler(idByParamsSchema, 'params'),categoryController.updateCategory);
